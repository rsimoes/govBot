...
def getNDLeg(partyDict):
    ##Manually update 63-2013 to the appropriate session-year when each session begins
    url = 'http://www.legis.nd.gov/assembly/63-2013/members/'
...
if __name__ == '__main__':
    ...
    dictList = getNDLeg(partyDict)
    with open(writePath + 'NDLeg.csv', 'w') as csvFile:
